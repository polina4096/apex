...
pub fn lead_in<I>(input: I, duration: Duration) -> LeadIn<I>
where
  I: Source,
  I::Item: Sample,
{
  ...
  I::Item: Sample,
{
  ...
  fn try_seek(&mut self, pos: Duration) -> Result<(), SeekError> {
    if pos < self.requested_duration {
      ...
      self.remaining_samples = remaining_samples(until_playback, self.sample_rate(), self.channels());
    } else {
